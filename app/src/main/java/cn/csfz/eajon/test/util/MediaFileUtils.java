...
/**
 * Utility class for media file judge, base on android.media.MediaFileUtils.java
...
public class MediaFileUtils {
     ...
     */
    private static boolean isDrmFileType(int fileType) {
    ...
    public static int getFileTypeForFile(String path) {
        return getFileTypeForMimeType(getMimeTypeForFile(path));
    }
    ...
    public static boolean isAudio(String path) {
        int fileType = getFileTypeForFile(path);
        return ((fileType >= FIRST_AUDIO_FILE_TYPE &&
                fileType <= LAST_AUDIO_FILE_TYPE) ||
                (fileType >= FIRST_MIDI_FILE_TYPE &&
                        fileType <= LAST_MIDI_FILE_TYPE));
     ...
     * @return if is playlist type , return true ; otherwise , return false ;
     */
    public static boolean isPlayList(String path) {
        int fileType = getFileTypeForFile(path);
        return (fileType >= FIRST_PLAYLIST_FILE_TYPE &&
                fileType <= LAST_PLAYLIST_FILE_TYPE);
    }
